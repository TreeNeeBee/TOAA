 ...
 *
 * 这是个"通用兜底"：LLM 写错了路径，XCompiler 在执行 Phase 交付入口检查之前
...
export async function ensurePyTestBootstrap(
  ...
  const content =
    `# Auto-generated by XCompiler ProjectOrchestrator.\n` +
...
/**
 * Phase 交付门禁的 fallback：尝试运行入口的 \`--help\`，确保工程"开箱即用"。
 *
 * 优先级：
 ...
 *   4. 若都不存在 → 返回 ok=false。入口是 Phase 交付门禁的强制验收项，不能依赖
